...
- Preserve pending records and Arrow batches when stream close fails while flushing, notify waiting futures/callbacks, and propagate Arrow close failures to callers.
